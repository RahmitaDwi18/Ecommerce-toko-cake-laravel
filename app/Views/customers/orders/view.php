...
<section class="ftco-section ftco-Keranjang Belanja">
    <div class="container">
        ...
        <div class="card card-primary">
            <div class="card-header" style="background: #ddb9a9; color :white;">
                <h5 class="card-heading" style="color :white;">Data Penerima</h5>
            </div>
            <div class="card-body p-0">
                <table class="table table-hover table-striped table-hover">
                    <tr>
                        <td style="background: #9b817a; color :white;">Nama</td>
                        <td><b><?php echo $delivery_data->customer->name; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: #937a74; color :white;">No. HP</td>
                        <td><b><?php echo $delivery_data->customer->phone_number; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: #9b817a; color :white;">Alamat</td>
                        <td><b><?php echo $delivery_data->customer->address; ?></b></td>
                    </tr>
                    <tr>
                        <td style="background: #937a74; color :white;">Catatan</td>
                ...
                <div class="text-center actionRow">
                    <?php if ($data->payment_method == 1) : ?>
                        <?php if ($data->order_status == 1) : ?>
                            ...
                            <a href="<?php echo base_url('customer_payments/confirm?order=' . $data->id); ?>" class="btn-confirm">Konfirmasi Pembayaran</a>
                            <br>
                            <a href="#" class="btn btn-dark mt-3" data-toggle="modal" data-target="#cancelModal">Batalkan</a>
                        ...
                        <?php elseif ($data->order_status == 4) : ?>
                            <p>Order selesai</p>
                            <a href="#" class="btn btn-dark" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i> Hapus</a>
                        <?php endif; ?>
                    <?php elseif ($data->payment_method == 2) : ?>
                        <?php if ($data->order_status == 1) : ?>
                            <p>Order dalam proses</p>
                            <a href="#" class="btn btn-dark" data-toggle="modal" data-target="#cancelModal"><i class="fa fa-times"></i> Batalkan</a>
                        <?php elseif ($data->order_status == 4) : ?>
                            <p>Order dibatalkan</p>
                            <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i> Hapus</a>
                        <?php elseif ($data->order_status == 2) : ?>
