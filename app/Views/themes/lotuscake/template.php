...
<head>
	...
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/open-iconic-bootstrap.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/animate.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/owl.carousel.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/owl.theme.default.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/magnific-popup.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/aos.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/ionicons.min.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/argon/js/plugins/@fortawesome/fontawesome-free/css/all.min.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/bootstrap-datepicker.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/jquery.timepicker.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/flaticon.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/icomoon.css') ?>>
	<link rel="stylesheet" href=<?= base_url('assets/themes/lotuscake/css/style.css') ?>>

	<link rel="stylesheet" href=<?= base_url('assets/plugins/toastr/toastr.min.css') ?>>

	<script src=<?= base_url('assets/themes/lotuscake/js/jquery.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/jquery-migrate-3.0.1.min.js') ?>></script>
</head>
...
<body class="goto-here">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-warning ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="logo" href="#"><img src="assets/uploads/sites/logo9.png" alt=""></a>
					...
					<div class="ftco-footer-widget mb-4">
						...
						<div class="d-flex">
							<ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
								...
								<!-- <li><a href="<?= base_url('shop/testimonial') ?>" class="py-2 d-block">Review Pelanggan</a></li> -->
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<p>
						...
						Copyright LotusCake&copy;<script>
	...
	<script src=<?= base_url('assets/themes/lotuscake/js/popper.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/bootstrap.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/jquery.easing.1.3.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/jquery.waypoints.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/jquery.stellar.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/owl.carousel.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/jquery.magnific-popup.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/aos.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/jquery.animateNumber.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/bootstrap-datepicker.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/scrollax.min.js') ?>></script>
	<script src=<?= base_url('assets/themes/lotuscake/js/main.js') ?>></script>
