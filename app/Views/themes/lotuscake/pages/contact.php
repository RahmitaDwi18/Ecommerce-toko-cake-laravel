...
<?= $this->section('konten'); ?>
<div class="hero-wrap hero-bread" style="background-image: url('<?= base_url('assets/themes/lotuscake/images/bg_14.jpg'); ?>');">
  <div class="container">
    ...
    <div class="row d-flex mb-5 contact-info">
      ...
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Alamat <br></span> <?php echo get_settings('store_address'); ?></p>
        </div>
      </div>
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
      ...
      <div class="col-md-3 d-flex">
        <div class="info bg-white p-4">
          <p><span>Website</span> www.LotusCake00.com</p>
        </div>
      </div>
    </div>
